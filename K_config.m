...
{'stimulus Record', 'ai7', 'analog input', 2500, [-.2,.2]} , ...
{'Stimulus Output', 'ao0', 'analog output', nan, [-5 5], 'stimuli'}, ...
...
tag.param_stim.Duration = 10; %seconds
tag.param_stim.Duration_post = 30; %or 10 seconds
...
tag.param_stim.Power = 0; %set manually on hardware, raised cosine power set HERE
