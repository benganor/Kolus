...
tag.param_stim.Type = 'train'; % 'train'
tag.param_stim.Duration_pre = 0.5; %seconds
tag.param_stim.Duration = .5; %seconds
tag.param_stim.Duration_post = 20; %or 10 seconds
...
tag.param_stim.Chance = 1; %likelihood of stimulus occuring
%For trains of pulses
tag.param_stim.Duration_pulse = 10; %milliseconds
tag.param_stim.Freq = 20; %Hertz - can be a CHIRP using start/end freq as in [5 20]
%for raised pulse_train_cosine
tag.param_stim.Power = 1; %set manually on hardware, raised cosine power set HERE
tag.param_stim.DC_cosine = 0;
tag.param_stim.Piezo_Chance = 1;
tag.param_stim.Piezo_Amp = 1;
